...
const SRC = path.join(__dirname, "il-agent-configs-data.ts");
...
const SLUG = process.env.FUNCTION_SLUG ?? "il-agent-configs-data-v1";
const NAME = process.env.FUNCTION_NAME ?? "IL Agent Configs Data v1";
